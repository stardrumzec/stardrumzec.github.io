...
import logo from '../../img/material-ui-logo.svg';
import lander from '../../img/lander.jpg';
  ...
  render() {
    ...
    return (
      <div className={classes.root}>
        <Plantilla titulo='StardrumzEC' />
        <Helmet>
          <title>Omar Estrella Drumz</title>
        </Helmet>
        <div className={classes.hero}>
          <div className={classes.content}>
            <img alt='Material-UI Logo' className={classes.logo} src={logo} />
